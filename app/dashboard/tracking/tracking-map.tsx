...
const truckIcon = L.divIcon({
  html: `<div style="
    ...
    border: 2px solid rgba(122,158,126,0.6);
    border-radius: 50%;
    box-shadow: 0 0 12px rgba(122,158,126,0.4), 0 4px 12px rgba(0,0,0,0.15);
    animation: marker-pulse 2s ease-in-out infinite;
  ">🚛</div>
  <style>
    @keyframes marker-pulse {
      0%, 100% { transform: scale(1); box-shadow: 0 0 12px rgba(122,158,126,0.4); }
      50% { transform: scale(1.08); box-shadow: 0 0 20px rgba(122,158,126,0.6); }
    }
  </style>`,
...
const homeIcon = L.divIcon({
  html: `<div style="
    ...
    border: 2px solid rgba(196,112,74,0.5);
    border-radius: 50%;
    ...
    <div className="w-full h-full">
      ...
      >
        ...
        <Marker position={userHome} icon={homeIcon}>
          <Popup>
            <div className="text-center p-1">
              <span className="font-syne font-bold text-sm text-[#C4704A] block">
                Your Location
              </span>
        ...
        <CircleMarker
          ...
          radius={30}
          pathOptions={{
            color: "rgba(196,112,74,0.25)",
            fillColor: "rgba(196,112,74,0.08)",
            fillOpacity: 0.5,
            weight: 1.5,
          }}
        />
          ...
          <>
            ...
            <CircleMarker
              ...
              pathOptions={{
                ...
                fillColor: "rgba(122,158,126,0.1)",
                fillOpacity: 0.6,
                weight: 1.5,
              }}
            />
